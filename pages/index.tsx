    ...
    <>
      ...
      <main className="p-6 h-full flex flex-col md:p-12 md:max-h-[800px]">
        ...
        <div className="max-w-sm md:pt-40">
          ...
          <a href="https://www.instagram.com/bamdokki" className="my-2 font-medium flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" className="mr-2 w-6 h-6">

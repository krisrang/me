  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="It's a me!" />
      </Head>

      <main>
        <h1>
          <span className="name">Kristjan Rang</span> develops software, occasionally
        </h1>
        ...
        <div className="contact">
          ...
          <a href="https://www.last.fm/user/BamDokki">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
          ...
          <a href="https://steamcommunity.com/id/bamdokki">
          ...
          <a href="https://goodreads.com/bamdokki">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path
                className="heroicon-ui"
          ...
          <a href="https://www.instagram.com/bamdokki">

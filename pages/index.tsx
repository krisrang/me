    ...
    <>
      ...
      <main className="p-6 h-full flex flex-col md:p-12 md:max-h-[800px]">
        ...
        <div className="max-w-sm md:pt-40">
          ...
          <a href="https://www.last.fm/user/schleeppy" className="my-2 font-medium flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" className="mr-2 w-6 h-6">
          ...
          <a href="https://steamcommunity.com/id/schleeppy" className="my-2 font-medium flex items-center">
          ...
          <a href="https://goodreads.com/schleeppy" className="my-2 font-medium flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="mr-2 w-6 h-6">
              <path
                className="heroicon-ui"
